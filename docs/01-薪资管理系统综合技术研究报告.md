        ...
        <table className="table">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {data?.employees.map((employee: Employee) => (
              <tr key={employee.id}>
                <td className="table-cell">{employee.employeeCode}</td>
...
class EmployeeBase(SQLModel):
    employee_code: str = Field(index=True, unique=True, max_length=20)
...
class EmployeeResponse(SQLModel):
    ...
    def from_db_model(db_employee: Employee) -> "EmployeeResponse":
        ...
        return EmployeeResponse(
            id=db_employee.id,
            employeeCode=db_employee.employee_code,
