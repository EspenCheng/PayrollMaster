...
```
第1行(英文字段名)： employeeId | name | department | position | hireDate | bankAccount | phone | email
第2行(中文字段名)： 员工工号    | 姓名  | 部门       | 职位     | 入职日期 | 银行账号     | 联系电话 | 邮箱
第3行(数据开始)：   RYJM-0000137269     | 张三  | 技术部      | 高级工程师 | 2020-01-15 | 6222 **** **** 1234 | 138****1234 | zhangsan@company.com
                      EMP002    | 李四  | 市场部      | 市场专员 | 2021-06-01 | 6222 **** **** 5678 | 139****5678 | lisi@company.com
```
